...
public class SentenceController{
	...
	public @ResponseBody String getSentence() {
		return 
			...
			getWord("MICROSPRING4-EUREKA-DISCOVERY-CLIENT-SUBJECT-LAB5", "/getSubject") + " "
			+ getWord("MICROSPRING4-EUREKA-DISCOVERY-CLIENT-VERB-LAB5") + " "
			+ getWord("MICROSPRING4-EUREKA-DISCOVERY-CLIENT-ARTICLE-LAB5") + " "
			+ getWord("MICROSPRING4-EUREKA-DISCOVERY-CLIENT-ADJECTIVE-LAB5") + " "
			+ getWord("MICROSPRING4-EUREKA-DISCOVERY-CLIENT-NOUN-LAB5") + "."
			;
	}
