...
public class SentenceController{
	...
	public @ResponseBody String getSentence() {
		return 
			...
			getWord("MICROSPRING4-EUREKA-DISCOVERY-CLIENT-SUBJECT-LAB4", "/getSubject") + " "
			+ getWord("MICROSPRING4-EUREKA-DISCOVERY-CLIENT-VERB-LAB4") + " "
			+ getWord("MICROSPRING4-EUREKA-DISCOVERY-CLIENT-ARTICLE-LAB4") + " "
			+ getWord("MICROSPRING4-EUREKA-DISCOVERY-CLIENT-ADJECTIVE-LAB4") + " "
			+ getWord("MICROSPRING4-EUREKA-DISCOVERY-CLIENT-NOUN-LAB4") + "."
			;
	}
